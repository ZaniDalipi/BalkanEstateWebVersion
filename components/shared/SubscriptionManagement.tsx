    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-md border border-neutral-200 p-6 space-y-4">
        ...
        <div className="grid sm:grid-cols-3 gap-4 mt-4">
          {/* Featured */}
          <div className="border border-gray-300 bg-white rounded-lg p-4 hover:border-gray-400 hover:shadow transition-all">
            <div className="flex items-center justify-between mb-2">
              <h5 className="font-bold text-gray-900">⭐ Featured</h5>
              <span className="text-xs bg-gray-100 text-gray-900 font-semibold px-2 py-1 rounded">From €1.99</span>
            </div>
            <p className="text-xs text-gray-600 mb-3">Stand out in search results with priority placement</p>
          ...
          {/* Highlight */}
          <div className="border-2 border-primary bg-white rounded-lg p-4 hover:shadow-md transition-all relative">
            <div className="absolute -top-2 right-2 bg-primary text-white text-xs font-medium px-2 py-0.5 rounded">
              Popular
            </div>
            <div className="flex items-center justify-between mb-2">
              <h5 className="font-bold text-gray-900">💎 Highlight</h5>
              <span className="text-xs bg-gray-100 text-gray-900 font-semibold px-2 py-1 rounded">From €3.99</span>
            </div>
            <p className="text-xs text-gray-600 mb-3">Maximum visibility with auto-refresh every 3 days</p>
            <ul className="space-y-1">
              <li className="text-xs text-gray-700 flex items-start gap-1.5">
                <span className="text-gray-400 mt-0.5">•</span>
          ...
          <div className="border border-gray-300 bg-white rounded-lg p-4 hover:border-gray-400 hover:shadow transition-all">
            <div className="flex items-center justify-between mb-2">
              <h5 className="font-bold text-gray-900">👑 Premium</h5>
              <span className="text-xs bg-gray-100 text-gray-900 font-semibold px-2 py-1 rounded">From €7.99</span>
            </div>
            <p className="text-xs text-gray-600 mb-3">Ultimate exposure with homepage featuring</p>
            <ul className="space-y-1">
              <li className="text-xs text-gray-700 flex items-start gap-1.5">
                <span className="text-gray-400 mt-0.5">•</span>
        ...
        <button
          ...
          onClick={() => {
            // Navigate to promotion plans modal or page
            window.alert('Viewing detailed promotion plans... (implement modal/page here)');
          }}
        >
          View All Promotion Plans & Pricing
        </button>
