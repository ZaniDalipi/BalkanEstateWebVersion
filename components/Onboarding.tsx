  ...
  return (
    <div className="min-h-screen bg-neutral-50 flex flex-col justify-center items-center p-4">
       <div className="text-center mb-12">
        ...
        <p className="text-xl text-neutral-600 mt-2 max-w-xl">Your gateway to properties in the Balkans. Find your dream home or sell with confidence.</p>
       </div>
      
      <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-xl w-full max-w-4xl border border-neutral-200">
        <h2 className="text-3xl font-bold text-center text-neutral-800 mb-8">How can we help you today?</h2>
