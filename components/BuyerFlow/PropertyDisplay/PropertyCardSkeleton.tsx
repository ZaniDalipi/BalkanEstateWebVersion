  ...
  return (
    <div className="bg-white rounded-lg overflow-hidden shadow-md border border-neutral-200 w-full flex flex-col animate-pulse">
      ...
      <div className="p-4 flex flex-col flex-grow">
        ...
        <div className="grid grid-cols-2 gap-x-4 gap-y-2 border-t border-neutral-100 pt-3">
        ...
        <div className="mt-4 pt-3 border-t border-neutral-100 flex justify-between items-center gap-2">
